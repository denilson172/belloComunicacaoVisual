	...
	<body>
		...
		<div class="container-contact100">
			<div class="wrap-contact100">
				<span class="contact100-form-title">DEFINA SEU PERFIL!</span>
				<h4 class="contact100-form-text light">Responda apenas 7 perguntas</h4>
				<h4 class="contact100-form-text light">Definiremos o seu perfil, é facinho :)</h4>

				<div class="container-contact100-form-btn">
					<button class="contact100-form-btn margin-top-20" onclick="javascript: location.href='questionario.php';"><span>COMEÇAR AGORA</span></button>
				</div>
			</div>
		</div>
		...
		<div class="container-contact100">
			<div class="wrap-contact100">
				<span class="contact100-form-title">CONHEÇA NOSSOS PLANOS!</span>
				<h4 class="contact100-form-text light">Após responder algumas perguntas vamos gera um perfil à sua cara :-) </h4>
				
				<!--PLANO 01-->
				<img class="img-planos contact100-form" src="../Style/img/planos/planos.png" alt="Minha Figura">
